    ...
    <>
      ...
      {cartItems.length === 0 ? (
        <Box className="h-screen flex flex-col items-center justify-center">
          ...
          <Text>
            Go to{" "}
            <Link href="/shop" className="no-underline text-blue-400">
              shop
            </Link>{" "}
            instead?
          </Text>
          ...
          <Box className="flex flex-col h-100 justify-between">
            ...
            <Box>
              <Box className="italic pb-3">
                For now, clicking checkout sends me a telegram message. I will
                need your telegram handle so I can contact you for payment,
